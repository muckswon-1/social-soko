...
import { login, refreshUser, forgotPassword, updatePassword, logout, register, verifySession, sendSixDigitCode, resetPasswordWithDigitCode, sendVerificationEmail, updateEmailWithDigitCode, verifyEmail } from "./authThunk"
...
// Actions
export const {finishBootstraping} = authSlice.actions;
