...
export default function PrivacyLayout() {
  ...
  const sectionMeta = {
    ...
    description:
      "Manage your personal info, account security, and how we contact you.",
    sectionLinks: [
       {to: "/dashboard/account-settings", title: "Profile Summary"},
      { to: "/dashboard/account-settings/update-password", title: "Update Password" },
      { to: "/dashboard/account-settings/update-email", title: "Update Email" },
    ],
  };
