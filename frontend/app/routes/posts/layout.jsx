// src/menu/posts/PostsLayout.jsx
...
export function meta() {
  return [{ title: "Feed | Social Soko" }];
}

export default function PostsLayout() {
   const sectionMeta = {
    header: "Feed",
     description: "See updates from your network and discover new opportunities.",
    sectionLinks: [
      { to: "/dashboard", title: "For you" },
      { to: "/dashboard/following", title: "Following" },
      { to: "/dashboard/explore", title: "Explore" },
      {to: "/dashboard/my-posts", title: "My Posts"}
     ],
   };
