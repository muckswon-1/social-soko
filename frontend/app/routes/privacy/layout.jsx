...
export default function PrivacyLayout() {
  const sectionMeta = {
    ...
    sectionLinks: [
      { to: "/dashboard/privacy", title: "Account Session Info" },
      { to: "/dashboard/privacy/update-password", title: "Update Password" },
      { to: "/dashboard/privacy/update-email", title: "Update Email" },
    ],
  };
