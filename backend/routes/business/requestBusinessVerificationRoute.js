...
/**
 * @swagger
 * /api/v1/business/{id}/request-verification:
 *   post:
 ...
 */
 ...
 requestBusinessVerificationRoute.post("/:id/request-verification",verifyAccessToken,requireRole(ROLES.ADMIN,ROLES.BUSINESS),requestBusinessVerification);
